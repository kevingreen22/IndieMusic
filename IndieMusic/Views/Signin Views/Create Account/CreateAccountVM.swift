...
class CreateAccountVM: ObservableObject {    
    ...
    func createAccount(completion: @escaping (Bool) -> Void) {
        ...
        let newUser = User(name: name, email: email, profilePictureURL: nil, profilePictureData: nil, songListData: [], favoriteArtists: nil, favoriteAlbums: nil, favoriteSongs: nil, recentlyAdded: nil, /*isArtistOwner: false,*/ artist: nil)
